...
for i in range(50):
    ...
    random.seed(SEED + i)
    # 1. Data inladen
    time_series = pd.read_csv('Scriptie_martijn/timeseries_import.csv')
    ...
    if results.solver.termination_condition == pyo.TerminationCondition.infeasible:
        solver.options['ResultFile'] = f'/Users/martijnkrikke/Documents/Scriptie/Scriptie_martijn/ILP files/example_model_iis_{i}.ilp'
    ...
    if results.solver.termination_condition == pyo.TerminationCondition.optimal:
        ...
        output_path = '/Users/martijnkrikke/Documents/Scriptie/Scriptie_martijn/output_results.csv'
